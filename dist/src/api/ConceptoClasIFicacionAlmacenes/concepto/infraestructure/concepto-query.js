...
exports.ConceptoManager = void 0;
const config_1 = require("../../../../database/config");
function ConceptoManager(action, Datos) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        COMMIT TRAN`;
            ...
            case "Eliminar":
                ...
                result = yield pool.request().input("Id", Datos.Id).query(query);
                break;
        }
        yield pool.close();
        if (result === null) {
...
exports.ConceptoManager = ConceptoManager;
